...
ps = scatter(I, M, bipartite=true, nodesize=degree(M), msc=:grey, size=(1000, 1000), dpi=600, msw=0.3)
scatter!(ps, I, networks["Shaw"], mc=cbfp[1], bipartite=true, nodesize=degree(M), msc=:grey, msw=0.3)
savefig(ps, "shaw.pdf")

ph = scatter(I, M, bipartite=true, nodesize=degree(M), msc=:grey, size=(1000, 1000), aspectratio=1, dpi=600, msw=0.5)
scatter!(ph, I, networks["HP3"], mc=cbfp[5], bipartite=true, nodesize=degree(M), msc=:grey, msw=0.5)
savefig(ph, "hp3.pdf")

pe = scatter(I, M, bipartite=true, nodesize=degree(M), msc=:grey, size=(1000, 1000), aspectratio=1, dpi=600, msw=0.5)
scatter!(pe, I, networks["EID2"], mc=cbfp[3], bipartite=true, nodesize=degree(M), msc=:grey, msw=0.5)
savefig(pe, "eid2.pdf")

pg = scatter(I, M, bipartite=true, nodesize=degree(M), msc=:grey, size=(1000, 1000), aspectratio=1, dpi=600, msw=0.5)
